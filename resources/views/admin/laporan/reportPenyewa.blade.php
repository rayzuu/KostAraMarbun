...
@section('content')
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('report.tenant') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="tenant_status" class="form-select">
                            ...
                            <option value="active" {{ $tenantStatus == 'active' ? 'selected' : '' }}>

                                Active

                            </option>

                            <option value="inactive" {{ $tenantStatus == 'inactive' ? 'selected' : '' }}>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <a href="{{ route('report.tenant.pdf', request()->query()) }}" class="btn btn-danger">
